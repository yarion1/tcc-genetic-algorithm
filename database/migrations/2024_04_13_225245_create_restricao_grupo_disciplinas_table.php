...
return new class extends Migration
{
    ...
    {
        Schema::create('restricao_grupo_disciplinas', function (Blueprint $table) {
            $table->id();
            $table->foreignId('restricao_grupo_evento_id')->constrained('restricao_grupo_eventos');
            $table->unsignedBigInteger('disciplina_id')->constrained('courses');
    ...
    {
        Schema::dropIfExists('restricao_grupo_disciplinas');
    }
};